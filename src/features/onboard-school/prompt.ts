...
6b. PROTEZIONE (piano AppleCare / Kyron Shield) — CHIEDI SEMPRE, una domanda per volta:
   ...
   d. MODALITA' ADD-ON: il piano protezione deve essere tra i prodotti del catalogo. Se non e' gia' stato selezionato nel ProductPicker dello step 6, dillo all'utente e proponi di rifare la selezione catalogo includendolo (il server lo gestisce come prodotto intero hidden-but-purchasable: il toggle storefront compare grazie all'enable). NON va messo nei componenti del bundle.
